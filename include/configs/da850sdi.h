...
#define CONFIG_SYS_DA850_DDR2_DDRPHYCR 	0x00000047

#define CONFIG_SYS_DA850_DDR2_SDBCR 	0x08934832

/* SDBCR2 is only used if IBANK_POS bit in SDBCR is set*/
#define CONFIG_SYS_DA850_DDR2_SDBCR2 0

#define CONFIG_SYS_DA850_DDR2_SDTIMR	0x204929C9

#define CONFIG_SYS_DA850_DDR2_SDTIMR2	0x0C12C722
